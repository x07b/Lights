...
export default function OrderDetailModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-white rounded-xl shadow-2xl max-w-sm w-full overflow-hidden flex flex-col animate-slide-up">
        {/* Header */}
        ...
        <div className="border-t border-border p-4 flex gap-2">
          <button
            ...
            className="flex-1 bg-accent text-white px-4 py-2 rounded-lg font-semibold text-sm hover:bg-accent/90 transition-colors"
          >
            Voir Détails
          </button>
          <button
            onClick={onClose}
            className="px-4 py-2 border border-border rounded-lg font-semibold text-sm hover:bg-secondary transition-colors"
          >
            Fermer
          </button>
        </div>
